...
model_load_path = "results/dqn/hot_v3_train_2025-03-24_23:06"
...
name= create_experiment_name(env_name=ENV_NAME, episodes=training_params['num_episodes'],algorithm_name=ALGORITHM_NAME)
