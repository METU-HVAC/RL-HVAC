...
def run_simulation(start_date, end_date, episode_type, steps_per_chunk,agent,train_interval,timesteps_per_hour,reward_config):
    ...
    while current_step < steps_per_chunk:
        ...
        normalized_reduced_state = normalize_observation(reduced_state,reduced_obs_means,reduced_obs_stds)
        ...
        if episode_type == "Training":
            ...
            normalized_next_reduced_obs = normalize_observation(next_reduced_state,reduced_obs_means,reduced_obs_stds)
...
def train(config=None):
    with wandb.init(config=config):
        ...
        state_size =  7 # Adjust based on the size of your observation space
        action_size = 76  
